import { StepsResponseFromJson } from './steps';
...
describe('Steps', () => {
  it('問題なく型変換が出来ること', () => {
    ...
    const steps = StepsResponseFromJson(
      '2024-10-07',
      offsetFromUTCMillis,
      json,
    );
    ...
    expect(steps.activitiesStepsIntraday?.dataset[0].dateTime).toEqual(
      new Date('2024-10-07T00:00:00.000+09:00'),
    );
    expect(steps.activitiesStepsIntraday?.dataset[0].steps).toEqual(267);
    expect(steps.activitiesStepsIntraday?.dataset[1].dateTime).toEqual(
      new Date('2024-10-07T00:05:00.000+09:00'),
    );
    expect(steps.activitiesStepsIntraday?.dataset[1].steps).toEqual(315);
    expect(steps.activitiesStepsIntraday?.dataset[2].dateTime).toEqual(
      new Date('2024-10-07T00:10:00.000+09:00'),
    );
